...
fakeuser1 = User.create!(email: "user1@mail.com", password: "121212", image: "https://images.unsplash.com/photo-1571512599285-9ac4fdf3dba9?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=987&q=80", first_name: "fake1", last_name: "user1", username: "fakeuser1", location: "Barcelona, Spain", credit_left: 735)
fakeuser2 = User.create!(email: "user2@mail.com", password: "121212", image: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2370&q=80", first_name: "fake2", last_name: "user2", username: "fakeuser2", location: "Madrid, Spain", credit_left: 39)
fakeuser3 = User.create!(email: "user3@mail.com", password: "121212", image: "https://pbs.twimg.com/media/FV_ZZHZXgAAGpBu?format=jpg&name=small", first_name: "fake3", last_name: "user3", username: "fakeuser3", location: "Lisbon, Portugal", credit_left: 250)
...
@items = [
          { name: "Coffee cup",
            ...
            user: fakeuser2 },
            { name: "Camping Gear",
            description: "After travelling around Portugal I don't need it anymore. Great condition! Hardly used.",
            credit: 53,
            location: "Lisbon, Portugal",
            image: '/assets/seed03_campinggear.jpg',
            user: fakeuser3 },
            { name: "tba",
            description: "tba",
            credit: 24,
